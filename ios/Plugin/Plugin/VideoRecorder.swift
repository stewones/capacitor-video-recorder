...
public class CAPVideoRecorderPlugin: CAPPlugin, AVCaptureFileOutputRecordingDelegate {
    ...
    public func fileOutput(_ output: AVCaptureFileOutput, didFinishRecordingTo outputFileURL: URL, from connections: [AVCaptureConnection], error: Error?) {
        ...
        self.stopRecordingCall?.success(["videoUrl": CAPFileManager.getPortablePath(host: self.bridge.getLocalUrl(), uri: outputFileURL)! as String, "videoUri": outputFileURL.absoluteString])
    }
